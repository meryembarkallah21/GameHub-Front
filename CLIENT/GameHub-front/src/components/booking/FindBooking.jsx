			...
			<div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
				...
				{isLoading ? (
					...
					<div className="col-md-6 mt-4 mb-5">
						...
						<p>Station Number: {bookingInfo.station.id}</p>
						<p>Station Type: {bookingInfo.station.stationType}</p>
						<p>
							Check-in Date:{" "}
						...
						<p>PcGamers: {bookingInfo.numOfPcGamers}</p>
						<p>ConsoleGamers: {bookingInfo.numOfConsoleGamers}</p>
